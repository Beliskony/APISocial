...
export class StoryRouter {
    ...
    private initializeRoutes(): void {
        this.router.post("/create/:user", StoryMiddleware(StoryZodSchema), this.storyController.createStory.bind(this.storyController));
        this.router.get("/getUser", StoryMiddleware(StoryZodSchema), this.storyController.getUserStories.bind(this.storyController));
        this.router.delete("/delete/:user/:story", StoryMiddleware(DeleteStoryZodSchema), this.storyController.deleteExpiredStories.bind(this.storyController));
