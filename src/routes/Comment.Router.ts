...
export class CommentRouter {
  ...
  private initializeRoutes(): void {
    this.router.post("/create/:postId", authenticateJWT, formParser, CommentMiddleware(CreateCommentZodSchema), this.commentController.addComment.bind(this.commentController));

    this.router.put("/update", authenticateJWT, formParser, CommentMiddleware(UpdateCommentZodSchema), this.commentController.updateComment.bind(this.commentController));
